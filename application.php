...
<?php
    ...
    {
      $mail = require __DIR__ . "/php-password-reset-main/mailer.php";
  
      $mail->setFrom("kadkoltaslimraza81@gmail.com");
      $mail->addAddress($email);
      $mail->Subject = "Cogratulation";
      $mail->Body = <<<END
  
      <h3><strong>Hello.$email</strong>;
       <h3>You have successfully applied for.$int_name ?><b> internship by.$company_name;?></b></h3>
