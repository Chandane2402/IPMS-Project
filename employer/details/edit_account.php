...
<?php
	if(isset($_POST['update'])){
		...
		$updateCus = "UPDATE employer SET nameOfCompany = '$emp_name',aboutCompany='$emp_about', email = '$emp_email', address1 = '$emp_address1', address2 = '$emp_address2', city = '$emp_city', state = '$emp_state', zipcode = '$emp_zipcode', phone = '$emp_phone', country = '$emp_country' WHERE email = '$emp_email'";
				...
				<form class="p-3 grey-text" method="post" action="" enctype="multipart/form-data">
					<div class="row">					
						...
						<div class="text-center mt-4">
			              	<button class="btn btn-default" type="submit" name="update" method="post">Update <i class="fa fa-paper-plane-o ml-1"></i></button>
			            </div>					
					</div>
				</form>
			</div>
